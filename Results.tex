...
\chapter{Results}
The results of the numerical simulations will be presented in this chapter.
...
A quick explanation of how the Bloch sphere is used for visualization is given in \Cref{sec:bloch-sphere}
...
To get some insight, the frequency spectrum, \Cref{fig:pulse_spectrum_gf}, shows large support at \(\omega_q\) and \(\omega_q+K_q\), while for longer pulses a peak at \(\omega_q-K_q\) disappears.
