...
\tikzfig{figs/energy-anharmonic}{The energy levels of a three-level resonator for anharmonicity \(\kappa\in[0,1]\) and \(\omega=1\). A resonator has \(\kappa~1\) while a qubit has \(\kappa\neq0\).}{fig:anharmonic-energies}{25em}{20em}
